        ...
        {  		
			...
			// Actual splitting of file into smaller files  
                ...
                {  
                    ...
                    FileWriter fstream1 = new FileWriter("D:/Downloads/fall sem 22-23/nandhini/files/"+fi+""+j+".txt");     // Destination File Location  
                    if(!(path.contains("D:/Downloads/fall sem 22-23/nandhini/files/"+fi+""+j+".txt")))
                    {
                        path.add("D:/Downloads/fall sem 22-23/nandhini/files/"+fi+""+j+".txt");
                    }
